...
| C0 calibration 180 | 162/180 label・QC accepted | moderate-temperature MD 27/27 accepted。strong-distortionは保留rawを残したままreplacementで18/18 acceptedを達成。残りはcurated graph-edit 18件 |
