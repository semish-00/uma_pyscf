...
| C0 calibration 180 | 180/180 label・QC accepted | curated graph-edit 18/18を含む全source quotaがscore非依存で完了。C0 exit evidence（sentinel、QC v2、cheap-signal評価）を次に固定する |
